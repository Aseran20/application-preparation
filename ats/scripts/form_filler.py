...
Usage:
    python ats/scripts/form_filler.py <platform> <section> --data '<json>'

Example:
    python ats/scripts/form_filler.py workday my_information --data '{"prefix": "Mr.", "given_name": "Adrian"}'
...
See ats/scripts/ for platform-specific implementations.
"""
...
from ats.scripts import fill_section, PLATFORMS
...
Example:
    py ats/scripts/form_filler.py workday my_information --data '{{"given_name": "Adrian"}}'
"""
    )
